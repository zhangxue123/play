...
class WGAN(object):
    ...
    def discriminator(self, x, is_training=True, reuse=False):
        ...
        with tf.variable_scope("discriminator", reuse=reuse):
            ...
            net = lrelu(bn(conv2d(net, 64, 4, 4, 2, 2, name='d_conv21'), is_training=is_training, scope='d_bn21'))
    ...
    def generator(self, z, is_training=True, reuse=False):
        ...
        with tf.variable_scope("generator", reuse=reuse):
            ...
            net = tf.nn.relu(
                bn(deconv2d(net, [self.batch_size, 14, 14, 64], 4, 4, 2, 2, name='g_dc31'), is_training=is_training,
                   scope='g_bn31'))
            net = tf.nn.relu(
                bn(deconv2d(net, [self.batch_size, 28, 28, 64], 4, 4, 2, 2, name='g_dc32'), is_training=is_training,
                   scope='g_bn32'))
            
            out = tf.nn.sigmoid(deconv2d(net, [self.batch_size, 56, 56, 3], 4, 4, 2, 2, name='g_dc4'))
